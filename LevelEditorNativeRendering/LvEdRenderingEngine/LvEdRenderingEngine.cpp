...
#include "../../GameBundle/Generated/RegisterSchemaObjects.h"
...
LVEDRENDERINGENGINE_API void  __stdcall LvEd_SetResourceRoot(wchar_t* path)
{
	ResourceManager::Inst()->m_ResourceRoot = std::wstring(path);
}
