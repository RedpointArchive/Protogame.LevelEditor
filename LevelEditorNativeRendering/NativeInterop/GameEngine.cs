...
namespace RenderingInterop
{
    ...
    public unsafe class GameEngine : DisposableObject, IGameEngineProxy, IInitializable
    {
        ...
        [DllImportAttribute("LvEdRenderingEngine", EntryPoint = "LvEd_SetResourceRoot", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        private static extern void NativeSetResourceRoot(string resourceRoot);
